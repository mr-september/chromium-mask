...
(async function () {
  ...
  try {
    ...
    const spoofedWidth =
      originalWidth || (spoofingData.userAgentData && spoofingData.userAgentData.platform === "macOS" ? 1440 : 1920);
    const spoofedHeight =
      originalHeight || (spoofingData.userAgentData && spoofingData.userAgentData.platform === "macOS" ? 900 : 1080);
